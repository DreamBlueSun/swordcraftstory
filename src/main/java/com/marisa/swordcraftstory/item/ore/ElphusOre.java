...
public class ElphusOre extends AbstractOre {
    ...
    public ItemStack weaponMake(ItemStack mouldStack) {
        ...
        switch (((Mould) mouldStack.getItem()).type()) {
            ...
            case SWORD:
                ...
                break;
            case AXE:
                stack = ItemRegistry.SYNTHESIS_AXE.get().getDefaultInstance();
                break;
            default:
    ...
    @Override
    public Item asSword() {
        return ItemRegistry.SYNTHESIS_SWORD.get();
    }

    @Override
    public Item asBow() {
        return ItemRegistry.SYNTHESIS_BOW.get();
    }

    @Override
    public Item asAxe() {
        return ItemRegistry.SYNTHESIS_AXE.get();
    }
    ...
    public boolean build(ItemStack stack) {
        stack.getOrCreateTag().put("story_combat_model_change", IntTag.valueOf(WeaponModels.ELPHUS_ORE.getId()));
