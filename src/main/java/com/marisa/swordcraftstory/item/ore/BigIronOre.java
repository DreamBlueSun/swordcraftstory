...
public class BigIronOre extends AbstractOre {
    ...
    @Override
    public Item asSword() {
        return ItemRegistry.WIDE_SWORD.get();
    }

    @Override
    public Item asBow() {
        return ItemRegistry.HUGER_BOW.get();
    }
    ...
    public boolean build(ItemStack stack) {
        stack.getOrCreateTag().put("story_combat_model_change", IntTag.valueOf(WeaponModels.BIG_IRON_ORE.getId()));
