...
public class FantasyOre extends AbstractOre {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("散发着奇异光辉的矿石").mergeStyle(TextFormatting.WHITE));
    }
    ...
    public boolean build(ItemStack stack) {
        stack.setTagInfo("story_combat_model_change", IntNBT.valueOf(WeaponModels.FANTASY_ORE.getId()));
