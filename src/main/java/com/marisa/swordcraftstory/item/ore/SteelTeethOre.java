...
public class SteelTeethOre extends AbstractOre {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("很坚硬难以加工很多人都无法使用").mergeStyle(TextFormatting.WHITE));
    }
    ...
    public boolean build(ItemStack stack) {
        stack.setTagInfo("story_combat_model_change", IntNBT.valueOf(WeaponModels.STEEL_TEETH_ORE.getId()));
