...
public class WeaponModelChangeTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {

    private Inventory inventory;

    private BlockPosIInt posIInt;

    public WeaponModelChangeTileEntity() {
        super(TileEntityTypeRegistry.WEAPON_MODEL_CHANGE_TILE_ENTITY.get());
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("gui." + Story.MOD_ID + ".weapon_model_change_tile_entity");
    }

    @Nullable
    @Override
    public Container createMenu(int sycID, PlayerInventory inventory, PlayerEntity player) {
        return new WeaponModelChangeContainer(sycID, inventory, this.getPos(), this.posIInt);
    }
