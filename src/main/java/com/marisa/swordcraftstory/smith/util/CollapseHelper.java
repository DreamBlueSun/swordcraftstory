...
public class CollapseHelper {
    ...
    private final static String ATK = "story_smith_collapse_atk";

    public static void setAtk(ItemStack stack, int value) {
        stack.getOrCreateTag().put(ATK, IntTag.valueOf(value));
    }
    ...
    private final static String DEF = "story_smith_collapse_def";
    ...
    private final static String PHY = "story_smith_collapse_phy";
    ...
    private final static String AGL = "story_smith_collapse_agl";
