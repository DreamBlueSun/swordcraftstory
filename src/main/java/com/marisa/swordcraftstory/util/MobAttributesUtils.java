...
//     * 新增属性
//     */
//    public static MobAttr newAttr(MobEntity mobEntity, Player closestPlayer) {
...
//        int lv = StoryPlayerDataManager.getLv(StoryPlayerDataManager.get(closestPlayer.getStringUUID()).getXp());
//        //随机+-1~2LV
