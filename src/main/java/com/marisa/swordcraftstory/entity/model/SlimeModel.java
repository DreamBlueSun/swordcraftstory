...
public class SlimeModel extends EntityModel<Slime> {
	...
	public SlimeModel() {
		...
		bb_main.setTextureOffset(0, 16).addBox(-3.0F, -7.0F, -3.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
	}

	@Override
	public void setRotationAngles(Slime entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
